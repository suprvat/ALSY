...
<head>
  ...
  <!-- font-awsome -->
  <script src="https://use.fontawesome.com/f85f413e0b.js"></script>
  <!-- icon-8 icons -->
  <a href="https://icons8.com/icon/Yuy5afbK3Pn9/headphone"></a>
  <!-- owl carousel -->
...
<body>
  ...
  <!-- HEADER -->
  <section id="head">
    <div style="background-color: rgb(240, 164, 208); height: 5rem;">

    </div>

    <div style="background-color:rgb(240, 164, 208); height: 20rem;">
    ...
    <section class="grid-category">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-xs-12 f-category i-category wow fadeIn" data-wow-delay="0s">
          ...
          <div class="col-lg-2 col-md-4 col-xs-12 f-category i-category wow fadeIn" data-wow-delay="0.2s">
            <a href="../show_products/show_products.php?cat_id=2">
              <div class="icon">
                <img src="https://img.icons8.com/cotton/64/000000/bicycle--v1.png" />
              </div>
              <h6>Cycles</h6>
            </a>
          </div>
